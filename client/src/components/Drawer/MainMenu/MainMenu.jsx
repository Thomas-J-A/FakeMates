                ...
                <nav className="mainMenuNav">
                  <ul className="mainMenuNav__list">
                    <li className="mainMenuNav__item">
                      <Link className="mainMenuNav__link" to={`/profile/${ currentUser._id }`} onClick={closeDrawer}>
                        <FontAwesomeIcon className="mainMenuNav__linkIcon" icon={faCircleUser} />
                        <span className="mainMenuNav__linkText">Profile</span>
                      </Link>
                    </li>
                    <li className="mainMenuNav__item">
                      <Link className="mainMenuNav__link" to="/messenger" onClick={closeDrawer}>
                        <FontAwesomeIcon className="mainMenuNav__linkIcon" icon={faMessage} />
